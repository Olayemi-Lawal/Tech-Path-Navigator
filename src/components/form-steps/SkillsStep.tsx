...
import { Code2, Database, Paintbrush, Globe, Terminal, FileSpreadsheet } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {skills.map((skill) => {
              ...
              return (
                ...
                >
                  <Icon className={`w-4 h-4 mt-0.5 mr-3 flex-shrink-0 ${isSelected ? 'text-primary-foreground' : 'text-primary'}`} />
