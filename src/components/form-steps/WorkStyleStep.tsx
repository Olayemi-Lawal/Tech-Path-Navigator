...
const WORK_STYLES = [
  {
    ...
    icon: Eye,
    description: "I love working with colors, layouts, and aesthetics",
  },
  {
    id: "analytical",
    label: "Analytical & Logical",
    icon: Brain,
    description: "I enjoy breaking down complex problems step by step",
  },
  {
    id: "collaborative",
    label: "Team Collaboration",
    icon: Users2,
    description: "I thrive when working closely with others",
  },
  {
    id: "independent",
    label: "Independent Work",
    icon: User,
    description: "I prefer focusing deeply on tasks alone",
  },
  {
    id: "structured",
    label: "Structured Process",
    icon: Clock,
    description: "I like clear plans and organized workflows",
  },
  {
    id: "flexible",
    label: "Fast & Flexible",
    icon: Zap,
    description: "I adapt quickly and enjoy dynamic environments",
  },
];

export const WorkStyleStep = ({ selected, onChange }: WorkStyleStepProps) => {
  const toggleWorkStyle = (styleId: string) => {
    const updated = selected.includes(styleId)
